...
app.get('/',(req,res) => res.json({"message": "Welcome to the data pokemon showdown API ! Available resources : abilities, items, learns, moves, natures, pokemons, pokemonTier"}))
